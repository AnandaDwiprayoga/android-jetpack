...
import com.example.jetpackpro.data.*
...
import com.example.jetpackpro.data.source.remote.response.ContentResponse
import com.example.jetpackpro.data.source.remote.response.CourseResponse
import com.example.jetpackpro.data.source.remote.response.ModuleResponse
...
class FakeAcademyRepository constructor(
    ...
    override fun getAllCourses(): LiveData<Resource<List<CourseEntity>>> {
        return object : NetworkBoundResource<List<CourseEntity>, List<CourseResponse>>(appExecutors){
            override fun loadFromDB(): LiveData<List<CourseEntity>> = localDataSource.getAllCourses()
            ...
            override fun saveCallResult(courseResponses: List<CourseResponse>) {
