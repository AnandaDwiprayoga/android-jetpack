...
import com.example.jetpackpro.ui.academy.FakeAcademyRepository
import com.example.jetpackpro.ui.utils.LiveDataTestUtil
...
class AcademyRepositoryTest {
    ...
    fun getBookmarkedCourses() {
        ...
        val courseEntitie = LiveDataTestUtil.getValue(academyRepository.getAllModulesByCourse(courseId))

        verify(remote).getModules(eq(courseId), any())

        assertNotNull(courseEntitie)
        assertEquals(moduleResponses.size.toLong(), courseEntitie.size.toLong())
    }
