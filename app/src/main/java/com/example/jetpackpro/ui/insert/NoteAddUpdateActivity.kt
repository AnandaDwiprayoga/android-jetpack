package com.example.jetpackpro.ui.insert
...
import com.example.jetpackpro.databinding.ActivityNoteAddUpdateBinding
import com.example.jetpackpro.helper.DataHelper
import com.example.jetpackpro.helper.ViewModelFactory
...
class NoteAddUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        noteAddUpdateViewModel = obatainViewModel(this@NoteAddUpdateActivity)
    ...
    private fun obatainViewModel(activity: NoteAddUpdateActivity): NoteAddUpdateViewModel {
